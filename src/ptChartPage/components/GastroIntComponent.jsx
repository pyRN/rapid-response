...
function GastroIntComponent() {
  ...
  return (
    <div
      className="card text-white m-2 rounded d-inline-flex col-lg p-0"
      style={{ border: "solid #BF8FCC" }}
    >
      <h5
        className="card-header text-dark text-center"
        style={{ backgroundColor: "#BF8FCC" }}
      >
        Gastrointestinal
      </h5>
...
export default GastroIntComponent;
